...
Future<void> registerHotKeys(OSC osc) async {
  /**Two Modifiers */
  HotKey goToCue = HotKey(
      key: LogicalKeyboardKey.keyG,
      modifiers: [HotKeyModifier.control, HotKeyModifier.shift],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(goToCue,
  ...
  HotKey address = HotKey(
      ...
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(address,
  ...
  HotKey clearCommandLine = HotKey(
      ...
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(clearCommandLine,
  ...
  HotKey softkey1 = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(softkey1,
  ...
  HotKey softkey2 = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(softkey2,
  ...
  HotKey softkey3 = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(softkey3,
  ...
  HotKey softkey4 = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(softkey4,
  ...
  HotKey softkey5 = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(softkey5,
  ...
  HotKey softkey6 = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(softkey6,
  ...
  HotKey moreSoftkeys = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(moreSoftkeys,
  ...
  HotKey selectActive = HotKey(
      ...
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(selectActive,
  ...
  HotKey selectLast = HotKey(
      ...
      modifiers: [HotKeyModifier.control],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(selectLast,
  ...
  HotKey home = HotKey(
      ...
      modifiers: [HotKeyModifier.control],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(home,
      keyDownHandler: (key) => osc.sendKey('home'));

  HotKey level = HotKey(
      key: LogicalKeyboardKey.keyL,
      modifiers: [HotKeyModifier.control],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(level,
      keyDownHandler: (key) => osc.sendKey('level'));

  HotKey saveShow = HotKey(
      key: LogicalKeyboardKey.keyU,
      modifiers: [HotKeyModifier.shift],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(saveShow,
  ...
  HotKey colorPalette = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(colorPalette,
  ...
  HotKey intensityPalette = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(intensityPalette,
  ...
  HotKey focusPalette = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(focusPalette,
  ...
  HotKey beamPalette = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(beamPalette,
  ...
  HotKey preset = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(preset,
  ...
  HotKey record = HotKey(
      ...
      modifiers: [HotKeyModifier.alt],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(record,
  ...
  HotKey recordOnly = HotKey(
      ...
      modifiers: [HotKeyModifier.control],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(recordOnly,
  ...
  HotKey plus10 = HotKey(
      ...
      modifiers: [HotKeyModifier.shift],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(plus10,
      keyDownHandler: (key) => osc.sendCmd('+%'));
  ...
  HotKey parenthesisLeft = HotKey(
      ...
      modifiers: [HotKeyModifier.shift],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(parenthesisLeft,
      keyDownHandler: (key) => osc.sendCmd('('));
  ...
  HotKey parenthesisRight = HotKey(
      ...
      modifiers: [HotKeyModifier.shift],
      scope: HotKeyScope.inapp);
  await hotKeyManager.register(parenthesisRight,
      keyDownHandler: (key) => osc.sendCmd(')'));
}
